...
const Modal: React.FC<ModalProps> = ({ isOpen, title, message, onSubmit, onCancel }) => {
  ...
  return (
    <div
      id="popup-modal"
      tabIndex={-1}
      className="w-screen flex fixed top-0 right-0 left-0 z-50 justify-center items-center md:inset-0 h-[calc(100%)] max-h-full overflow-y-auto overflow-x-hidden"
    >
