    ...
    return (
        isVisible && (
            ...
            >
                ...
                {icon === 'success' ? (
                    <div className="inline-flex items-center justify-center shrink-0 w-8 h-8 text-green-500 bg-green-100 rounded-lg dark:bg-green-800 dark:text-red-200" data-testid="success-icon">
                        <svg
                            className="w-5 h-5"
                            aria-hidden="true"
                    ...
                    <div className="inline-flex items-center justify-center shrink-0 w-8 h-8 text-red-500 bg-red-100 rounded-lg dark:bg-red-800 dark:text-red-200" data-testid="error-icon">
